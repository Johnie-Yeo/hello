...
REST api에서는 강의 목록 조회와 학생 목록 조회 2번의 요청이 필요하게 될 것입니다. 이렇게 내가 필요한 정보를 단일 api가 충족시키지 못해 여러 번 요청해야 하는 것을 *under-fetching* 이라 합니다. under fetching이 왜 안좋은지 모르시는 분들은 HTTP의 요청방식에 대해 공부해 보시면 됩니다.
